...
<head>
	...
	<?php $ch = curl_init('http://na.api.pvp.net/api/lol/static-data/na/v1.2/champion/18?champData=all&api_key=80a03926-6e55-4045-bf6f-692ec7007ca1');
...
<body>
	<div id="champ_info">
		<div id="champ_square">
			<img src="/champs/square/Tristana.png">
		</div>
		<div id="champ_header">
		...
		<div id="lore_box" style="background-image: "../splash/Tristana_0.jpg">
			<div id="champ_tabs">
				<h3>Lore</h3>
			</div>
			<div id="champ_lore">
